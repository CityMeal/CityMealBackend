...
class Rating {
    ...
    async updateRating(req,res) {
        try{
            console.log("rating params", req.params.rating_id, "rating", req.body.rating);
    
            //get Rating
            let updatedRating = await knex('ratings').where({id:req.params.rating_id}).update({rating: req.body.rating}).returning(['id','user_id','location_id', 'rating']);
